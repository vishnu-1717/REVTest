...
export default function OnboardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show them their unique webhook URL and invite code
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-sm text-green-700">
                  Save your invite code to share with team members
                </p>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg font-mono text-2xl font-bold text-center">
                  {inviteCode}
                </div>
